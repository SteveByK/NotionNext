...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，This is Steve,nice to visit my peisonal website🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Steve', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'a good man', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.withliterature.top/', // 网站地址
  ...
  MUSIC_PLAYER_METING_SERVER:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_SERVER || 'spotify', // 音乐平台，[netease, tencent, kugou, xiami, baidu]
  ...
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'steve', // 你的用户名 e.g tangly1024
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'steve_root', // 管理员用户名、一般是自己 e.g 'tangly1024'
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'this is what', // 站点描述，被notion中的页面描述覆盖
